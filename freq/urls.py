...
urlpatterns = patterns(
    ...
    url(r'^download/$', views.DownloadAllView.as_view(), name='download'),
    ...
    url(r'^additive/$', views.AdditiveView.as_view(),
        name='additive'),
    url(r'^frequency/$', views.FrequencyView.as_view(), name='frequency'),
    ...
    url(r'^additive_data/$', views.AdditiveDataView.as_view(),
        name='additive_data'),
